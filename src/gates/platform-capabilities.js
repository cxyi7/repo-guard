...
export const platformCapabilities = Object.freeze([
  defineLegacyCapability({ id: 'quality.stylelint', configKey: 'preCommit.stylelint', featureName: 'stylelint', featureOrder: 30, doctorOrder: 160, environments: ['pre-commit', 'ci-full'], mutation: 'working-tree-fix', allowedMutations: ['working-tree-fix', 'read-only'], before: ['quality.eslint'], requiredTools: ['stylelint'], supportsFix: true, inspectSetup: setup.stylelint }),
  defineLegacyCapability({ id: 'quality.eslint', configKey: 'preCommit.eslint', featureName: 'eslint', featureOrder: 10, doctorOrder: 130, environments: ['pre-commit', 'ci-full'], mutation: 'working-tree-fix', allowedMutations: ['working-tree-fix', 'read-only'], before: ['quality.prettier'], requiredTools: ['eslint'], supportsFix: true, inspectSetup: setup.eslint }),
  defineLegacyCapability({ id: 'quality.prettier', configKey: 'preCommit.prettier', featureName: 'prettier', featureOrder: 20, doctorOrder: 170, environments: ['pre-commit', 'ci-full'], mutation: 'working-tree-fix', allowedMutations: ['working-tree-fix', 'read-only'], requiredTools: ['prettier'], supportsFix: true, inspectSetup: setup.prettier }),
  ...
  defineLegacyCapability({ id: 'repository.protected-files', environments: ['pre-commit', 'ci-policy', 'ci-full'], mutation: 'external-write', allowedMutations: ['external-write', 'read-only'] }),
  ...
  defineLegacyCapability({ id: 'quality.typecheck', configKey: 'typeCheck', featureName: 'typeCheck', featureOrder: 130, doctorOrder: 40, environments: ['manual', 'pre-push', 'ci-full'], defaultTimeoutMs: DEFAULT_TYPE_CHECK_CONFIG.timeoutMs, manualCommand: 'typecheck', manualOrder: 50, packageScript: 'guard:typecheck', requiredScripts: ['config:typeCheck.script'], inspectSetup: setup.typecheck }),
  defineLegacyCapability({ id: 'quality.unit-test', configKey: 'unitTest', featureName: 'unitTest', featureOrder: 140, doctorOrder: 50, environments: ['manual', 'pre-push', 'ci-policy', 'ci-full'], defaultTimeoutMs: DEFAULT_UNIT_TEST_CONFIG.timeoutMs, manualCommand: 'unit-test', manualOrder: 60, packageScript: 'guard:unit-test', requiredTools: ['vitest'], requiredScripts: ['config:unitTest.script'], artifactTypes: ['coverage-report'], inspectSetup: setup.unitTest }),
  defineLegacyCapability({ id: 'quality.accessibility-test', configKey: 'accessibilityTest', featureName: 'accessibilityTest', featureOrder: 100, doctorOrder: 60, environments: ['manual', 'pre-push', 'ci-full'], defaultTimeoutMs: DEFAULT_ACCESSIBILITY_TEST_CONFIG.timeoutMs, manualCommand: 'accessibility-test', manualOrder: 120, packageScript: 'guard:accessibility-test', requiredScripts: ['config:accessibilityTest.script'], inspectSetup: setup.accessibility }),
  defineLegacyCapability({ id: 'quality.architecture', configKey: 'architecture', featureName: 'architecture', featureOrder: 90, doctorOrder: 20, environments: ['manual', 'pre-push', 'ci-full'], defaultTimeoutMs: DEFAULT_ARCHITECTURE_CONFIG.timeoutMs, manualCommand: 'architecture', manualOrder: 40, packageScript: 'guard:architecture', requiredTools: ['dependency-cruiser'], inspectSetup: setup.architecture }),
  defineLegacyCapability({ id: 'quality.build', configKey: 'build', featureName: 'build', featureOrder: 110, doctorOrder: 10, environments: ['manual', 'pre-push', 'ci-full'], defaultTimeoutMs: DEFAULT_BUILD_CONFIG.timeoutMs, manualCommand: 'build', manualOrder: 30, packageScript: 'guard:build', requiredScripts: ['config:build.script'], artifactTypes: ['build-output'], inspectSetup: setup.build }),
  defineLegacyCapability({ id: 'quality.lighthouse', configKey: 'lighthouse', featureName: 'lighthouse', featureOrder: 120, doctorOrder: 30, environments: ['manual', 'pre-push'], defaultTimeoutMs: DEFAULT_LIGHTHOUSE_CONFIG.timeoutMs, manualCommand: 'lighthouse', manualOptions: ['--skip-build'], manualOrder: 160, packageScript: 'guard:lighthouse', requiredTools: ['@lhci/cli'], artifactTypes: ['lighthouse-report'], inspectSetup: setup.lighthouse }),
  defineLegacyCapability({ id: 'quality.style-complexity', configKey: 'preCommit.stylelint.complexity', featureName: 'styleComplexity', featureOrder: 60, environments: ['manual'], manualCommand: 'style-complexity', manualOrder: 130, packageScript: 'guard:style-complexity', requiredTools: ['stylelint'] }),
  defineLegacyCapability({ id: 'quality.style-governance', configKey: 'preCommit.stylelint.governance', featureName: 'styleGovernance', featureOrder: 70, environments: ['manual'], manualCommand: 'style-governance', manualOrder: 140, packageScript: 'guard:style-governance', requiredTools: ['stylelint'] }),
]);
