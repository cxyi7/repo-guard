...
export const PROTECTED_PRE_COMMIT_STEPS = Object.freeze([
  ...
  Object.freeze({ id: 'quality.function-documentation', gateId: 'quality.function-documentation', mutation: 'read-only' }),
  ...JAVA_QUALITY_STEPS,
  ...
  Object.freeze({ id: 'security.source-security', gateId: 'security.source-security', mutation: 'read-only' }),
