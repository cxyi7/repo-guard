...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      from: { path: '^src/core/' },
      to: { path: '^src/(?:gates/|orchestration/|integrations/|commands/)' },
    },
    {
      ...
      from: { path: '^src/gates/' },
      to: { path: '^src/(?:orchestration/|commands/)' },
    },
    {
    ...
    },
    {
      ...
      to: { path: '^src/(?:gates/|orchestration/|commands/)' },
    },
    {
    ...
    },
    {
      ...
      from: { path: '^src/(?:orchestration/|commands/)' },
